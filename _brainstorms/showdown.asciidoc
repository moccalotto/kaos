...
"Agent". An agent is a relatively small computer residing in a shielded case to
make it robust aginst Digital Chaos. The first agents were quite large, taking
up about 4 x 10 x 10 centimeters, but the later models take up about 2 x 5 x 10
centemeters.

An agent is an "AI" that makes it much easier to use the device on which it
...
only active when it is inserted into an agent-enabled devices.
This means that your agent can "live" in your PDA or wrist-comp on a
